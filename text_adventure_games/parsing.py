...
class Parser:
    ...
    def get_characters_at_location(self, location: Location):
        # TODO: this might be fine for small games, but will suffer as size increases
        local_characters = []
...
class GptParser(Parser):
    ...
    def ok(self, description):
        ...
        print("Passed Command History:")
        print(self.command_history[-3:])
...
class GptParser2(GptParser):
    ...
    def determine_intent(self, command):
        ...
        choices = ''.join(lst)
        prompt_beg = "You are matching an input text to the most similar action phrase.\
If you are unsure of the correct input, the action is most likely \"go\".\n\
