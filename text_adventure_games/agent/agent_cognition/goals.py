...
from text_adventure_games.agent import impressions, memory_stream
...
class Goals:
    ...
    def gpt_generate_goals(self, game: "Game") -> str:
       ...
       system_prompt = goal_prompt.gpt_goals_prompt.format(world_info=game.world_info, persona_summary=self.character.persona.summary)
       ...
       user_prompt = {"Reflection of previous round: \n{ref} \n\n Impressions: \n{imp}"}.format(ref = reflection, imp = self.character.impressions.get_multiple_impression(char_objects) )
